...
export default function ReportPage() {
  ...
  const goddessTitle = useMemo(() => {
    ...
    if (garden.flowers >= 5) return "Blooming Beauty 🌸";
    return "Soft & Steady 🌷";
  }, [stats, garden]);
  ...
  const cards = [
    ...
    { icon: <Sparkles className="w-5 h-5 text-yellow-500" />, label: "Garden flowers", value: garden.flowers, sub: `${garden.streak}d streak` },
  ];
        ...
        <Card className="border-2 border-rose-200 bg-gradient-to-br from-rose-50 via-pink-50 to-amber-50 shadow-md overflow-hidden">
          <CardContent className="pt-6 pb-6 text-center">
            ...
            <div className="mt-4 flex items-center justify-center gap-2 flex-wrap">
              ...
              <Badge className="bg-amber-100 text-amber-700 border-0">{garden.flowers} 🌸</Badge>
            </div>
          </CardContent>
        </Card>
      </motion.div>
